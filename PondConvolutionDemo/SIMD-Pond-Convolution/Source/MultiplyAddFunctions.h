...
#include <immintrin.h>
#include "ComplexMultiplicationFunctions.cpp"
...
inline void complexMultiplicationSIMD(float* output,
    float* left,
    float* right,
    int numElements)
{
    ...
    {
        // TODO PICK UP FROM HERE! UGH... OKAY LET'S DO THIS! // This will crash on a non-AVX2 machine!
        _mm256_fmadd_ps(*outputReal, *leftReal, *rightReal);
        _mm256_fmadd_ps(*outputReal, *leftImag, *rightImag);
